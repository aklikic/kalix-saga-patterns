...
public class WalletCalls {
    ...
    public void chargeWallet(String walletId,String expenseId, WalletApiModel.WalletCommand.ChargeWallet chargeWallet) {
        ResponseEntity<Void> response = webClient.patch().uri("/wallet/" + walletId + "/charge/"+expenseId)
